...
class StayRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    public function FindPatientStays(int $id): array
    {
        ...
        Where id_Patient_id = :id and bed.id = stay.id_bed_id and bed.id_hospital_room_id = hospital_room.id and service.id = hospital_room.id_service_id and stay.activate = 1
        GROUP BY stay.id
